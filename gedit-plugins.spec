...
Source0:	http://ftp.gnome.org/pub/GNOME/sources/gedit-plugins/2.91/%{name}-%{version}.tar.bz2
# Source0-md5:	fb7a4b6a8c7c1a6716a3e169147aeacd
URL:		http://www.gnome.org/projects/gedit/
BuildRequires:	autoconf >= 2.59
BuildRequires:	automake >= 1:1.11
BuildRequires:	gedit2-devel >= 2.91.6
...
Requires:	gedit2 >= 2.91.6
Requires:	gtksourceview3 >= 2.91.9
